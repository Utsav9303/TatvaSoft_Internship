...
var uploadedImagePath = Path.Combine(Directory.GetCurrentDirectory(), "UploadedImage", "Mission");
var uploadMissionImagePath = Path.Combine(Directory.GetCurrentDirectory(), "UploadMissionImage", "Mission");

if (!Directory.Exists(uploadedImagePath))
{
    Directory.CreateDirectory(uploadedImagePath);
}
if (!Directory.Exists(uploadMissionImagePath))
{
    Directory.CreateDirectory(uploadMissionImagePath);
}

// Serve files from UploadedImage directory
app.UseStaticFiles(new StaticFileOptions
{
    FileProvider = new PhysicalFileProvider(
        Path.Combine(Directory.GetCurrentDirectory(), "UploadedImage")),
    RequestPath = "/UploadedImage",
    ServeUnknownFileTypes = true,
    DefaultContentType = "image/jpeg"
});

// Serve files from UploadMissionImage directory
app.UseStaticFiles(new StaticFileOptions
{
    FileProvider = new PhysicalFileProvider(
